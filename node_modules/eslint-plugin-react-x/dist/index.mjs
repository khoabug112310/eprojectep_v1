...
function canFix(context, node) {
  ...
  switch (node.callee.type) {
    case AST_NODE_TYPES.Identifier:
      return ER25.isInitializedFromReact(node.callee.name, importSource, initialScope);
    case AST_NODE_TYPES.MemberExpression:
      return node.callee.object.type === AST_NODE_TYPES.Identifier && ER25.isInitializedFromReact(node.callee.object.name, importSource, initialScope);
    default:
      return false;
  }
}
