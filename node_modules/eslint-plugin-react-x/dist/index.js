...
function canFix(context, node) {
  ...
  switch (node.callee.type) {
    case types.AST_NODE_TYPES.Identifier:
      return ER25__namespace.isInitializedFromReact(node.callee.name, importSource, initialScope);
    case types.AST_NODE_TYPES.MemberExpression:
      return node.callee.object.type === types.AST_NODE_TYPES.Identifier && ER25__namespace.isInitializedFromReact(node.callee.object.name, importSource, initialScope);
    default:
      return false;
  }
}
...
var RULE_NAME37 = "no-nested-lazy-component-declarations";
var RULE_FEATURES37 = [];
var no_nested_lazy_component_declarations_default = createRule({
  meta: {
    ...
    messages: {
      noNestedLazyComponentDeclarations: "Do not declare lazy components inside other components. Instead, always declare them at the top level of your module."
    },
    schema: []
  },
  name: RULE_NAME37,
